...
const segitigaSamaSisi = detectTriangle(1,1,1);
const segitigaSamaKaki = detectTriangle(4,4,2);
const segitigaSembarang = detectTriangle(3,4,6);

const segitigaSembarang1 = detectTriangle(1, false, 1) 
const segitigaSembarang2 = detectTriangle('a',3, 5)
const segitigaSembarang3 = detectTriangle(12,2,null)

console.log(segitigaSamaSisi)
console.log(segitigaSamaKaki);
console.log(segitigaSembarang);
console.log(segitigaSembarang1);
console.log(segitigaSembarang2);
console.log(segitigaSembarang3);
